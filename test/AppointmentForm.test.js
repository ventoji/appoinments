...
const itRendersAsATextBox = (fieldName) =>
  it('renders as a text box', () => {
    render(<AppointmentForm />);
    expectToBeSelectField(field(fieldName));
  });
  ...
  //  itSubmitsExistingValue('service', 'service');
  //  itSubmitsNewValue('service', 'service');
   
   it.skip('save existing values when submit', async () => {
   ...
   /*
   it('save new values when submit', async () => {
    expect.hasAssertions();
    render(<AppointmentForm 
       service="Cut"
       onSubmit={ ({service}) =>{
